...
<body class="bg-[#181616]">
    ...
    <section id="home" class="justify-between flex flex-wrap  w-full">
        ...
        <div>
            <img src="https://i.ibb.co/56mf6p3/Rectangle-2.png" alt="" class="mr-20">
        </div>
    ...
    <section id="portofolio" class="mt-14">
        ...
        <img src="https://i.ibb.co/WpqKRSg/Rectangle-6.png" alt="Gambar 1">
        <img src="https://i.ibb.co/5jdBB1r/Rectangle-5.png" alt="Gambar 2">
        </div>
    ...
    <section id="services">
        ...
        <div class="grid-container mt-20 ml-11">
            <div class="grid-item border-blue-500 border-2 text-center text-white text-3xl">
                <img src="https://i.ibb.co/w6ff8bR/Rectangle-8.png" alt="" class="ml-32">
    ...
    <footer class="bg-orange-600 text-white py-11 mt-16">
        <div class="container mx-auto text-center">
            ...
            <img src="https://i.ibb.co/89hf648/Vector.png" alt="" class=" ">
            <img src="https://i.ibb.co/FWhNkHY/skill-icons-instagram.png" alt="" class="">
            <img src="https://i.ibb.co/TcFwgss/logos-whatsapp-icon.png" alt="" class="">
            </div>
        </div>
    </footer>
